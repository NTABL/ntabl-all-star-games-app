...
export default function AnnouncerControlGamesScreen() {
        ...
        >
          ...
          <View style={styles.heroCard}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.title}>Choose Game — Announcer Control</Text>
            <Text style={styles.subtitle}>Select the game you are operating. The control screen opens with the live lineups, score, inning, outs, and current batter.</Text>
          </View>
                ...
                <View style={styles.gameBody}>
                  ...
                  >
                    <Ionicons
                      ...
                      style={{ marginRight: 7 }}
                    />
                    <Text style={styles.openButtonText}>Open Game Control</Text>
                  </View>
                </View>
              </Pressable>
            ))
