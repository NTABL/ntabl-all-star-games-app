...
export default function ChangePasswordScreen() {
  ...
  function showMessage(
    ...
    setReturnAfterSuccess(goBackAfter);
  ...
  async function handleChangePassword() {
    ...
    try {
      ...
      const email = manager?.email || manager?.managerEmail;

      if (!email) {
        showMessage(
          "error",
          "Missing Email",
          "Could not determine your manager email."
        );
        return;
      }
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.title}>Manager Password</Text>
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            <Ionicons
              ...
              size={54}
              color={
                isError ? "#c62828" : isWarning ? "#f97316" : "#15803d"
              }
