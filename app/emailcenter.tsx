...
export default function EmailCenterScreen() {
        ...
        >
          ...
          <View style={styles.heroCard}>
            ...
            <Text style={styles.subtitle}>
              Create and send email messages to selected players, All-Star managers, or anyone missing a waiver.
            </Text>
          </View>
...
<View style={styles.sectionCard}>
          ...
          <Text style={styles.versionFooter}>
            NTABL All-Star App • Email Communications
          </Text>
        </ScrollView>
      </View>
